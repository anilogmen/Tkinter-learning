...
#fotoğraf
#label ile de yapabilirdim ama canvas daha iyi.
...
title_info_label = Label(text="Enter your title",font=("Verdena",10,"normal"))
title_info_label.pack()
title_entry = Entry(width=30)
title_entry.pack()

input_info_label = Label(text="Enter your secret",font=("Verdena",10,"normal"))
